...
class UNet(
    ...
    def __init__(
        ...
        kernel_size: int,
        spec_transform: modulation.audio_utilities.torch_transforms.Spectrogram,
        inv_spec_transform: modulation.audio_utilities.torch_transforms.InverseSpectrogram,
        optimizer_lr: float,
    ) -> None:
        super().__init__()
